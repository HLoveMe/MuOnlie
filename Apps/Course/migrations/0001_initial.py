# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-05-13 04:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_image', models.ImageField(upload_to='course/%Y/%h', verbose_name='课程图标')),
                ('course_click_nums', models.IntegerField(verbose_name='课程点击量')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('download', models.FileField(upload_to='course/%Y/%h', verbose_name='资源地址')),
